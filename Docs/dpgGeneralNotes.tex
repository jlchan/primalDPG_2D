...
\begin{figure}
\centering
\subfigure[Poisson OAS (elem)]{\includegraphics[width=.49\textwidth]{figs/oaselem_large.eps}}
\subfigure[Poisson  OAS (face neighbors)]{\includegraphics[width=.49\textwidth]{figs/oasface_large.eps}}
\subfigure[Poisson  OAS (patch)]{\includegraphics[width=.49\textwidth]{figs/oaspatch_large.eps}}
