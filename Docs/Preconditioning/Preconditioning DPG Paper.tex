...
\input{primalResults.tex} % Jesse

\subsection{Ultraweak DPG}
\input{ultraweakResults.tex} % Nate

\subsection{Scalability: Camellia}
\input{CamelliaScalability.tex} % Nate

\section{Conclusions}
\input{conclusions.tex} % Nate

\clearpage

\bibliography{lit,./dpg}
