...
\newcommand{\PoissonTwoDGMGSchwarzAlgebraicStart}{3} %for the k=4 results, in a separate AllGMG file
	...
	\centering
		\scalebox{\plotscaling}{
			...
			\begin{axis}[
			  ...
			  \addplot table [header=false, x index=\meshwidthindex, y index=\iterationcountindex, each nth point=\PoissonTwoDNthPoint, skip first n=\value{algebraiccounter}, filter discard warning=false, unbounded coords=discard, skip coords between index={\PoissonTwoDStrideGMG}{\maxmyrows}]{data/PoissonDriver2D_results_AllGMG_4096_ranks_nonconforming.dat};
			  \addplot table [header=false, x index=\meshwidthindex, y index=\iterationcountindex, each nth point=\PoissonTwoDNthPoint, skip first n=\value{geometriccounter}, filter discard warning=false, unbounded coords=discard, skip coords between index={\PoissonTwoDStrideGMG}{\maxmyrows}]{data/PoissonDriver2D_results_AllGMG_4096_ranks_nonconforming.dat};
			  \addtocounter{geometriccounter}{\PoissonTwoDStrideGMG}
			  \addtocounter{algebraiccounter}{\PoissonTwoDStrideGMG}
			  \addplot table [header=false, x index=\meshwidthindex, y index=\iterationcountindex, each nth point=\PoissonTwoDNthPoint, skip first n=\value{algebraiccounter}, filter discard warning=false, unbounded coords=discard, skip coords between index={\PoissonTwoDStrideGMG}{\maxmyrows}]{data/PoissonDriver2D_results_AllGMG_4096_ranks_nonconforming.dat};
			  \addplot table [header=false, x index=\meshwidthindex, y index=\iterationcountindex, each nth point=\PoissonTwoDNthPoint, skip first n=\value{geometriccounter}, filter discard warning=false, unbounded coords=discard, skip coords between index={\PoissonTwoDStrideGMG}{\maxmyrows}]{data/PoissonDriver2D_results_AllGMG_4096_ranks_nonconforming.dat};
			  \addtocounter{geometriccounter}{\PoissonTwoDStrideGMG}
			  \addtocounter{algebraiccounter}{\PoissonTwoDStrideGMG}
