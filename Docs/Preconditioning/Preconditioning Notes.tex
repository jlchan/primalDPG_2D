...
%qsub -t 60 -n 128 --mode c16 -A Camellia ../StokesCavityFlowGMGDriver --k_coarse=0 --azOutput=100 --enforceOneIrregularity --gmgMaxIterations=10000 --relativeTol=1e-8 --minTol=1e-8 --polyOrder=2 --delta_k=1 --numRefs=6 --numCells=2 --smootherOverlap=1 --use3D
\begin{table}
\begin{tabular}{ c  c  c  c  c  c c}
Ref. Number	&Num. Elements	& Num. Global dofs		&Energy Error	&Num. Iterations	&Condest.\\
\hline
