function [x flag relres iter resvec] = agmg_solve_nullA(levels, b, maxIter, tol, x0);
...
if(strcmp(ktype, 'GMRES'))
    [x flag relres iter resvec] = my_gmres_nullA(A, b, maxIter, ...
                                                 tol, 1, levels);
    return;
end
if(strcmp(ktype, 'CG'))
    [x flag relres iter resvec] = my_pcg_nullA(A, b, maxIter, ...
                                               tol, levels);
    return;
end